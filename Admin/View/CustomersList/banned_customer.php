                            ...
                            <table class="table text-textBlack border-separate space-y-6 text-sm w-[1200px] overflow-y-scroll">
                                <thead class="bg-[#fffafa] text-textBlack ">
                                    <tr>
                                        ...
                                        <th class="px-3 py-6 text-center">Reason</th>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4">
                        <div class="">
                            ...
                            <div class="mt-3  ml-4 text-left">
                                <span class="text-center block pb-4 mt-7">You are about to unban the following user:</span>
                                ...
                                <h1 class="font-semibold mt-2 ">Banned Reason: <input class="font-normal drop-shadow-lg pl-2 " placeholder="Reason" type="text"></h1>
