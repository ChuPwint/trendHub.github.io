...
<body class="bg-[<?php
    ...
    <div class="flex justify-center items-center flex-col px-5">
        ...
        <div class="bg-primary relative md:w-1/2 flex justify-center items-center  shadow-2xl md:mt-5 mt-10  py-8">
            ...
            <div class="p-8 md:w-1/2 text-center">
                ...
                <form action="../../Controller/forgotPasswordController.php" method="post">
                    <input type="email" name="email" placeholder="Email" required class="w-full py-1 md:py-2 px-3 rounded border border-[<?php
      ...
      ?>] mb-4 focus:outline-none focus:ring-2">
                    ...
                    <button type="submit" name="forgotPw" class="w-full py-1 mt-3 md:py-2 px-4 text-sm md:text-base bg-[<?php
