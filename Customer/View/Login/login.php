        ...
        <div class="bg-primary relative   mx-10 md:w-1/2 flex justify-center items-center  shadow-2xl md:mt-5 mt-10 ">
            ...
            <div class="p-8 md:w-1/2 text-center">
                ...
                <form action="../../Controller/editController.php" method="POST">
                    ...
                    <a href="./profile.php"><button type="submit" name="login" class="w-full py-1 md:py-2 mb-10 mt-4 px-4 text-sm md:text-base bg-tertiary text-white rounded hover:[#FF5500] focus:outline-none focus:ring-2">Login</button></a>
