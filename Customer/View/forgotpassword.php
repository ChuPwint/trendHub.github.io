    ...
    <div class="flex justify-center items-center">
        ...
        <div class="bg-primary absolute top-20 right-1/4 flex justify-center items-center w-1/2 shadow-2xl mt-12">
            <div class="hidden md:block w-1/2 p-8 mt-10 mb-10">
                <img src="./assets/images/forgot_password.png" alt="Illustration Photo" class="w-full h-full object-cover">
            </div>
            <div class="p-8 md:w-1/2 text-center">
                ...
                <form action="#" method="POST">
                    <input type="email" name="email" placeholder="Email" required class="w-full py-1 md:py-2 px-3 rounded border border-[#FF5500] mb-4 focus:outline-none focus:ring-2">
                    <button type="submit" class="w-full py-1 md:py-2 px-4 text-sm md:text-base bg-tertiary text-white rounded hover:[#FF5500] focus:outline-none focus:ring-2 focus:ring-blue-600">Reset Password</button>
                </form>
                <p class="text-xs md:text-sm text-medium mt-2">Remember your password? <a href="/login" class="underline">Log in</a></p>
            </div>
        </div>
    </div>
</body>
