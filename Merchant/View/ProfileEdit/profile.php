    ...
    <section class="sectionContainer w-full flex relative">
        ...
        <div id="sideBarContainer" class="bg-tertiary w-20 h-screen p-2">
            ...
            <div class="px-2 mt-5">
                ...
                <p class="hoverImg py-2 px-2 mt-4 flex justify-center shadow-md bg-[#FBFBFB] bg-opacity-50 hover:bg-darkGreenColor rounded-md text-white cursor-pointer">
                    <img id="notiHover" src="../resources/img/sideBarImg/notification.png" alt="">
                    <span class="sideFull hidden ml-2">Notifications</span>
                </p>
                <p class="hoverImg py-2 px-2 mt-4 flex justify-center shadow-md 50 bg-darkGreenColor rounded-md  hover:text-white cursor-pointer">
