    ...
    <section class="sectionContainer w-full flex relative">
        ...
        <div id="sideBarContainer" class="bg-tertiary w-20 h-screen p-2">
            ...
            <div class="px-2 mt-5">
                ...
                <p class="hoverImg py-2 px-2 mt-4 flex justify-center shadow-md  bg-darkGreenColor text-white rounded-md hover:text-white cursor-pointer">
                ...
                <p class="hoverImg py-2 px-2 mt-4 flex justify-center shadow-md bg-[#FBFBFB] bg-opacity-50 hover:bg-darkGreenColor rounded-md text-black hover:text-white cursor-pointer">
                    <img id="notiHover" src="../resources/img/sideBarImg/notification.png" alt="">
                    <span class="sideFull hidden ml-2">Notifications</span>
                </p>
                <p class="hoverImg py-2 px-2 mt-4 flex justify-center shadow-md bg-[#FBFBFB] bg-opacity-50 hover:bg-darkGreenColor  rounded-md  hover:text-white cursor-pointer">
        ...
        <!-- Left-side Categories End-->
         ...
         <div class="contactAdminFinishModal fixed w-full h-full pt-16 bg-black bg-opacity-50 z-20 justify-center">
        ...
        <div class="bg-white md:bg-[url('../resources/img/contact/contact_bg.svg')] bg-cover bg-center py-5 rounded-md drop-shadow-xl md:flex md:items-center md:drop-shadow-none md:pl-20 md:space-x-28">
            ...
            <div class="text-center md:text-start px-5 py-5">
                ...
                <button type="submit" class="w-full bg-secondary shadow-md py-2 rounded text-white mt-5 md:w-[277px]">Send</button>
            </div>
